    ...
    <section class="bg-white mt-8 mb-10 mx-5">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
            ...
            <div class="flex justify-center flex-wrap p-4">
                <img class="rounded-xl max-w-full" src="{{ asset('image/exp1.jpg') }}" alt="Marigold Flowers in Bali">
            ...
            <div class="flex justify-center flex-wrap p-4">
                <img class="rounded-xl max-w-full max-h-[500px]" src="{{ asset('image/exp2.png') }}" alt="Marigold-based Products">
                <p class="pt-2 text-['Poppins'] text-lg text-justify font-medium max-w-full sm:max-w-2xl mt-4">
