...
<body class="flex flex-col min-h-screen">
    ...
    <section class="bg-white mt-8 mb-10 mx-4 sm:mx-8 lg:mx-16 flex-1">
        ...
        <div class="mx-auto mt-8 grid max-w-full sm:max-w-xl divide-y divide-neutral-200">
            <!-- FAQ Item 1 -->
            <div class="py-5">
                <details class="group">
                    <summary class="flex cursor-pointer list-none items-center justify-between font-medium text-lg sm:text-xl md:text-2xl">
                    ...
                    <p class="group-open:animate-fadeIn mt-3 text-neutral-600 text-sm sm:text-base md:text-lg">
